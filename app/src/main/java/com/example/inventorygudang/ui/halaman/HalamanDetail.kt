...
import com.example.inventorygudang.model.DetailsViewModel
import com.example.inventorygudang.model.ItemDetailsUiState
import com.example.inventorygudang.model.PenyediaViewModel
import com.example.inventorygudang.model.toBarang
...
fun DetailsScreen(
    ...
    Scaffold(
        topBar = {
            ...
            FloatingActionButton(
                onClick = { navigateToEditItem(uiState.value.detailBarang.id) },
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.edit_barang),
                )
            }
        }, modifier = modifier
    ) { innerPadding ->
